...
function generateTelemetry() {
    ...
    if (missionTime > 0 && missionTime < 100)
        state = 'ASCENT';
    else if (missionTime >= 100 && missionTime < 110)
        state = 'APOGEE';
    else if (missionTime >= 110 && missionTime < 250)
        state = 'DESCENT';
    else if (missionTime >= 250 && missionTime < 260)
        state = 'PROBE_RELEASE';
    else if (missionTime >= 260 && missionTime < 450)
        state = 'PAYLOAD_RELEASE';
    else if (missionTime >= 450)
        state = 'LANDED';
